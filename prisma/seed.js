...
async function main() {
  ...
  const departments = [
    ...
    [
      "Arts & Humanities",
      "Languages, literature, history and creative subjects."
    ],
    [
      "Commercial",
    ...
    [
      "Technology",
      "Computer studies, ICT and technology subjects."
    ]
  ];
  ...
  const studentEntries = [
    {
      ...
      middleName: "Amina",
      lastName: "Nwankwo",
      email: "ada.nwankwo@student.school",
      phone: "+2348021110001",
      status: "ACTIVE"
    },
    {
      ...
      middleName: "Tari",
      lastName: "Okafor",
      email: "daniel.okafor@student.school",
      phone: "+2348021110002",
      status: "ACTIVE"
    },
    {
      ...
      middleName: "Ebere",
      lastName: "Agu",
      email: "chiamaka.agu@student.school",
      phone: "+2348021110003",
      status: "ACTIVE"
    }
  ];
  ...
  for (const student of studentEntries) {
    ...
    const className = student.studentId.endsWith("001")
      ? "SS 1"
      : student.studentId.endsWith("002")
        ? "SS 2"
        : "SS 3";
  ...
  const alumniEntries = [
    ...
    },
    {
      ...
      company: "Crestcare Hospital",
      location: "Kaduna",
      bio: "Committed to community health outreach and patient care."
    }
  ];
  ...
  const newsItems = [
    {
      ...
      excerpt:
        "Students will showcase robotics, prototypes and practical experiments across science departments.",
      content:
        "The annual school science fair will open this Friday with projects spanning robotics, environment, health and STEM innovation. Parents, guardians and community partners are invited to explore student-led solutions and celebrate creativity.",
      imageUrl:
        "https://images.unsplash.com/photo-1503676260728-1d2f6f0f2b5b?auto=format&fit=crop&w=1200&q=80",
    ...
    },
    {
      ...
      excerpt:
        "A modern ICT space has been opened to strengthen digital literacy and project-based learning.",
      content:
        "The school recently commissioned a new digital learning lab with updated workstations, internet access and collaborative tools. The facility will support coding, research and multimedia learning for learners in junior and senior classes.",
      imageUrl:
    ...
    },
    {
      ...
      excerpt:
        "Students are preparing for a high-energy finale focused on leadership, public speaking and civic engagement.",
      content:
        "This year’s inter-house debate finals will bring together the best speakers from across the school. The event is expected to highlight research, confidence and disciplined argumentation in a highly competitive format.",
      imageUrl:
  ...
  const eventItems = [
    {
      ...
      description:
        "Meet our teachers, tour the campus and learn about student support systems and academic pathways.",
    ...
    },
    {
      ...
      description:
        "Students will engage in coding, robotics and problem-solving sessions with visiting professionals.",
    ...
    },
    {
      ...
      description:
        "A celebration of music, dance, drama and traditional performance from across the school community.",
  ...
  const galleryItems = [
    {
      ...
      caption:
        "Learners explore practical science in a modern lab."
    },
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1503676260728-1d2f6f0f2b5b?auto=format&fit=crop&w=1200&q=80",
      caption:
        "Focused lessons and collaborative study groups."
    },
    {
      title: "School Event",
      imageUrl:
        "https://images.unsplash.com/photo-1523240795612-9a054b0db644?auto=format&fit=crop&w=1200&q=80",
      caption:
        "Students connect with families during the school open day."
    },
    {
      ...
      imageUrl:
        "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1200&q=80",
      caption:
        "Students develop coding and digital confidence."
    }
  ];

  for (const item of galleryItems) {
    const existing = item.title
      ? await prisma.galleryPhoto.findFirst({
